...
const KB = {
  ...
  interior: "الجبس والديكور، الدهانات بكل أنواعها، بديل الرخام والخشب، التصميم الداخلي، جلي البلاط والرخام، المطابخ، أعمال الإيبوكسي",
  ...
  epoxy: `أعمال الإيبوكسي من أحدث وأفخم خدماتنا! نقدم:\n• إيبوكسي أرضيات للمنازل والمحلات والمستودعات\n• إيبوكسي ثلاثي الأبعاد (3D) بتصاميم مذهلة\n• إيبوكسي مضاد للانزلاق للحمامات والمطابخ\n• إيبوكسي شفاف حامٍ للأرضيات الموجودة\n• أكثر من 50 لون وتأثير مختلف`,
};
...
function generateReply(userMsg: string): string {
  ...
  if (msg.match(/خدم|ماذا تقدم|ما هي|قائمة|كل/)) {
  ...
  if (msg.match(/ايبوكسي|إيبوكسي|epoxy|ايبو|أرضية لامعة/)) {
    return `أعمال الإيبوكسي من أرقى خدماتنا! ✨\n\n🔹 **ما هو الإيبوكسي؟**\nطلاء راتينجي متين يُطبّق على الأرضيات ليمنحها مظهراً لامعاً وفاخراً مع حماية استثنائية.\n\n🎨 **أنواعنا:**\n• إيبوكسي عادي بألوان متعددة (أكثر من 50 لون)\n• إيبوكسي ثلاثي الأبعاد (3D) بتصاميم مذهلة كالبحر والأحجار والغابات\n• إيبوكسي مضاد للانزلاق للحمامات والمطابخ\n• إيبوكسي شفاف لحماية الأرضيات الموجودة\n\n✅ **مميازته:**\n• مقاومة فائقة للخدش والبقع والمواد الكيماوية\n• سهل جداً التنظيف\n• عمر افتراضي يتجاوز 10 سنوات\n• جاهز للاستخدام خلال 24-48 ساعة فقط\n• مضاد للميكروبات والبكتيريا\n\n📍 **مناسب لـ:** المنازل، المحلات التجارية، المستودعات، المستشفيات، الصالات الرياضية\n\n📞 احجز كشف مجاني وشاهد عينات الألوان: **${COMPANY_INFO.phone}**`;
  }
  ...
  if (msg.match(/مرحبا|اهلا|السلام|هلا|مساء|صباح/)) {
    return `أهلاً وسهلاً بك في مؤسسة الخطيب للمقاولات! 🌟\n\nأنا **أحمد**، مساعدك الذكي وخبير التشطيبات والمقاولات. يسعدني مساعدتك في:\n\n🏠 **داخلي:** جبس وديكور، دهانات، إيبوكسي، مطابخ، جلي رخام\n🏗️ **خارجي:** قصارة إسبانية، عزل مائي وحراري، دهان خارجي\n🔧 **صيانة:** ترميم وتجديد المباني\n\n✨ **جديد:** خدمة الإيبوكسي بتأثيرات ثلاثية الأبعاد!\n\nما الذي يمكنني مساعدتك فيه اليوم؟`;
  }

  // Default comprehensive response
  return `شكراً لتواصلك معنا! 🌟\n\nمؤسسة الخطيب للمقاولات تقدم:\n\n🏠 **داخلية:** جبس وديكور، دهانات، إيبوكسي 3D، مطابخ، جلي رخام\n🏗️ **خارجية:** قصارة إسبانية، عزل، دهان خارجي\n🔧 **صيانة:** ترميم مباني، تجديد شامل\n\n💡 **نصيحتي لك:** احجز **كشف موقع مجاني** الآن وسنقدم لك تسعيرة مفصلة وشفافة بدون أي التزام!\n\n📞 **${COMPANY_INFO.phone}**`;
}
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "bot",
      text: `أهلاً وسهلاً! 👋 أنا **أحمد**، مساعد مؤسسة الخطيب للمقاولات.\n\nأنا خبير في جميع خدماتنا:\n🏠 جبس وديكور • دهانات • إيبوكسي 3D • مطابخ\n🏗️ قصارة إسبانية • عزل مائي • دهان خارجي\n🔧 صيانة وترميم مباني\n\n✨ **جديد:** أرضيات إيبوكسي بتأثيرات مذهلة!\n\nكيف يمكنني خدمتك اليوم؟`,
      time: formatTime()
    }
  ]);
