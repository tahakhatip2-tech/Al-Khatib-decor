...
export const SERVICES = [
  ...
  },
  {
    id: "epoxy-works",
    category: "interior",
    title: "أعمال الإيبوكسي",
    description: "أرضيات وأسطح إيبوكسي احترافية ذات تشطيب فاخر ومتين، مثالية للمنازل والمحلات التجارية والمستودعات. تتميز بمقاومتها الفائقة للخدش والبقع والرطوبة مع مظهر لامع وأنيق.",
    icon: Diamond,
    image: "/images/hero-3d.png",
    gallery: [
      "/images/hero-3d.png",
    ...
    features: [
      "مقاومة فائقة للخدش والكسر",
      "سهل التنظيف والصيانة",
      "تشكيلة واسعة من الألوان والتأثيرات",
      "مناسب للمطابخ والحمامات والمستودعات",
      "طبقة شفافة حاملة لعمر افتراضي أطول",
      "تنفيذ سريع وجاهز للاستخدام خلال 24 ساعة",
